...
class MeetingPrepTasks():
    def research_task(self, agent, meeting_participants, meeting_context):
        return Task(
            description=dedent(f"""\
                Comduct comprehensive reaserch on each of the individuals and companies
                ...
                Particpants: {meeting_participants},
                Meeting context: {meeting_context}
                """
            ),
            expected_output=dedent(f"""\
                A detailed report on each participant and their company, highliting information
                that could be relevant to the meeting.
                """),
            agent=agent,
    ...
    def meeting_strategy_task(self, agent, meeting_context, meeting_objective):
        return Task(
            description=dedent(f"""\
                Develop stragetic talking points, questions and discussion angles for the
                meeting based on the research and industry analysis conducted.
            ...
            expected_output=dedent(f"""\
                Complete list with a list of key talking points, strategic questions to ask
